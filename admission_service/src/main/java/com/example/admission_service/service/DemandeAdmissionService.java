...
import com.example.admission_service.domain.*;
import com.example.admission_service.repos.*;
import com.example.admission_service.model.*;
import com.example.admission_service.config.*;
...
public class DemandeAdmissionService {
    ...
    public void sendEmail(String to, String subject, String html) throws MessagingException, jakarta.mail.MessagingException {
